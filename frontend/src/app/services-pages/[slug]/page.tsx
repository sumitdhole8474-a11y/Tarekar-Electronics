...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!service) {
    return {
      title: "Service Not Found | Tarekar Electronics",
    };
  }

  const serviceTitle = service.title || "Tarekar Electronics";

  // ✅ NEW STRUCTURE
  const title = ` ${serviceTitle}  | Tarekar Electronics`;

  const description =
    service.short_description ||
    `Looking for the best ${serviceTitle} in Amaravati? Tarekar Electronics provides trusted and professional services tailored to your needs.`;

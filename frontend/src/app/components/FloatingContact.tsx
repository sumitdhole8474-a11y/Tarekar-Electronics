  ...
  return (
    <div className="fixed bottom-8 right-8 z-50 flex flex-col items-center gap-4">
      ...
      >
        {/* Facebook - Blue */}
        <a
          href="https://www.facebook.com/tarekarradiosamt"
          target="_blank"
        ...
        <a
          href="https://www.instagram.com/sonyexclusive.amravati"
          target="_blank"
          rel="noopener noreferrer"
        ...
        {/* Google - Red */}
        <a
          href="https://share.google/nYUSArYsdVcJ48vR6"
          target="_blank"
          rel="noopener noreferrer"

        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl md:rounded-3xl shadow-2xl border border-white/50 p-5 md:p-12">
          ...
          >
            <div className={inputWrapperClass}>
              <User size={18} className="md:hidden absolute left-3 text-gray-400" />
              <User size={20} className="hidden md:block absolute left-4 text-gray-400" />
              <input
                name="customerName"
            ...
            <div className={inputWrapperClass}>
              <Phone size={18} className="md:hidden absolute left-3 text-gray-400" />
              <Phone size={20} className="hidden md:block absolute left-4 text-gray-400" />
              <input
                name="mobileNumber"
            ...
            <div className={inputWrapperClass}>
              <Mail size={18} className="md:hidden absolute left-3 text-gray-400" />
              <Mail size={20} className="hidden md:block absolute left-4 text-gray-400" />
              <input
                name="email"
            ...
            <div className={inputWrapperClass}>
              <Package size={18} className="md:hidden absolute left-3 text-gray-400" />
              <Package size={20} className="hidden md:block absolute left-4 text-gray-400" />
            ...
            <div className={`${inputWrapperClass} md:col-span-2 items-start relative`}>
              <MessageSquare size={18} className="md:hidden absolute left-3 top-3.5 text-gray-400" />
              <MessageSquare size={20} className="hidden md:block absolute left-4 top-4 text-gray-400" />
